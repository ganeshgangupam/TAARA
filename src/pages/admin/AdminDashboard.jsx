  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans">
      ...
      <div className={`flex-1 transition-all duration-300 ${isCollapsed ? 'md:ml-20' : 'md:ml-64'}`}>
        <AdminTopbar title={activeTab} isCollapsed={isCollapsed} />
        ...
        <main className="p-6 md:p-8 max-w-7xl mx-auto animate-in fade-in duration-500">
          <div className="flex justify-between items-center mb-6">
            ...
            {activeTab === 'products' && (
              <Button onClick={handleAddProduct} className="bg-brand-charcoal text-white hover:bg-black gap-2 shadow-lg hover:shadow-xl transition-all">
